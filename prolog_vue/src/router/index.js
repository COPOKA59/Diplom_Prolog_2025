...
import { MainPage, AdvancedSearchPage } from '@/modules/core/pages/index.js';
import { LoginPage, Profile, Settings, AuthorProfile, AuthorSeries, AuthorStories } from '@/modules/user/pages/index.js';
import { StoryCardsPage, StoryPage, StoryChapterPage, StoryHeader, StoryStructure,
  ...
  WorldbuildingPage, ItemsListPage, SeriesEditingPage, SeriesStoriesPage } from '@/modules/works/pages/index.js';
